...
import (
	...
	gio "github.com/walkon/wsgnet/internal/io"
	"github.com/walkon/wsgnet/internal/netpoll"
	...
	bsPool "github.com/walkon/wsgnet/pkg/pool/byteslice"
)
...
type conn struct {
	...
	isWebSock      bool                    // WebSocket protocol
}
...
func (c *conn) GetNoDelay() (int, error)       { return socket.GetNoDelay(c.fd) }
...
func (c *conn) SetWebSock(ws bool) {
	c.isWebSock = ws
}

func (c *conn) IsWebSock() bool {
	return c.isWebSock
}
